...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-amber text-ink shadow-[0_10px_30px_rgba(255,193,7,0.45)] transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover:scale-105 group-active:scale-95">
        {/* pulse */}
        <span className="absolute inset-0 animate-ping rounded-full bg-amber/50 [animation-duration:2.5s]" />
