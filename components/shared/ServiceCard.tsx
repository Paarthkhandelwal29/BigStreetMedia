...
export function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <Link
      ...
      className="group relative flex h-full flex-col overflow-hidden rounded-[1.25rem] border border-[#f0f0f0] bg-surface p-4 sm:p-6 transition-all duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-1 hover:border-amber hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)]"
    >
      ...
      <span className="flex h-9 w-9 sm:h-11 sm:w-11 items-center justify-center rounded-lg bg-amber/15 text-amber-deep transition-transform duration-300 group-hover:scale-110">
