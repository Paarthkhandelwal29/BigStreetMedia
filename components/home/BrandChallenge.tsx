        ...
        {challenges.map((c) => {
          ...
          return (
            <RevealItem key={c.label}>
              <Link
                href={c.route}
                className="group flex h-full flex-col justify-between rounded-[1.5rem] border border-[#f0f0f0] bg-surface p-7 transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-1 hover:border-[#e6e6e6] hover:shadow-[0_18px_40px_rgba(0,0,0,0.06)]"
              >
                <div>
