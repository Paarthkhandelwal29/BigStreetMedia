...
export default function AdminLoginPage() {
  ...
  return (
    <div className="container-bsm flex min-h-[70vh] items-center justify-center py-20">
      <form action={formAction} className="w-full max-w-md rounded-[1.5rem] border border-[#ececec] bg-surface p-8">
        <p className="eyebrow">Admin Access</p>
        <h1 className="mt-3 text-3xl font-bold text-ink">Sign in</h1>
        <p className="mt-3 text-sm text-muted">Use the admin password from your environment variables.</p>
        <input
          type="password"
          name="password"
          value={password}
